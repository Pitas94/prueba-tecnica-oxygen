...
export class UnitConverterComponent {
  ...
  comprobarTipoConversion(event:Event){
    const tipoConversion = (event.target as HTMLSelectElement).value
    this.conversion = tipoConversion
    const separarMedidas = tipoConversion.split('-')
